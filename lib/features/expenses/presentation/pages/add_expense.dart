...
class AddExpenseScreen extends StatefulWidget {
  const AddExpenseScreen({super.key, this.forUpdate=false, this.expense,this.index});
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () async{
                      String uuid='';
                      widget.forUpdate!?
                      context.read<ExpenseBloc>().add(UpdateExpenseEvent(id: widget.expense!.id, expense: Expense(id: widget.expense!.id, title: _titleController.text, amount: _amountController.text,futureExpense: futureExpense,category: selectedCat,  date: _dateController.text,isSynced: false))):
                      [uuid=const Uuid().v4(), context.read<ExpenseBloc>().add(AddExpenseEvent(
                          expense: Expense(
                    ...
                    child: Text( widget.forUpdate!?'Update Expense':'Add Expense')),
              )
            ],
          ),
        ),
