...
class AddIncomeScreen extends StatefulWidget {
  const AddIncomeScreen({super.key, this.forUpdate=false, this.income,this.index});
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () {
                      String uuid='';
                      widget.forUpdate!?
                      context.read<IncomeBloc>().add(UpdateIncomeEvent(id: widget.income!.id, income: Income(id: widget.income!.id, title: _titleController.text,futureIncome: futureIncome, amount: _amountController.text, date: _dateController.text,isSynced: false))):
                      [uuid=const Uuid().v4(),context.read<IncomeBloc>().add(AddIncomeEvent(
                        income: Income(
                  ...
                  child: Text( widget.forUpdate!?'Update Income':'Add Income')),
              )
            ],
          ),
        ),
